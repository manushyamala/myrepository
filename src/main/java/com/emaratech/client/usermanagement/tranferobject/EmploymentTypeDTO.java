...
public class EmploymentTypeDTO implements Serializable{
	...
	private static final long serialVersionUID = -6052060459424026824L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmploymentTypeDTO other = (EmploymentTypeDTO) obj;
	...
	public String toString() {
		return "EmploymentTypeDTO [id=" + id + ", descEnglish=" + descEnglish
