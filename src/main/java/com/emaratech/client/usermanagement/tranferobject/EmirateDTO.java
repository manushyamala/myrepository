...
public class EmirateDTO implements Serializable{
	
	private static final long serialVersionUID = -6666380154939423636L;
	private long id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmirateDTO other = (EmirateDTO) obj;
	...
	public String toString() {
		return "EmirateDTO [id=" + id + ", descEnglish=" + descEnglish
