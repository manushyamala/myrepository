...
public class EmployeeRankDTO implements Serializable{
	
	private static final long serialVersionUID = -7642973065473847367L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmployeeRankDTO other = (EmployeeRankDTO) obj;
	...
	public String toString() {
		return "EmployeeRankDTO [id=" + id + ", descEnglish=" + descEnglish
				+ ", descArabic=" + descArabic + ", readOnly=" + readOnly
				+ ", archived=" + archived + "]";
	}
