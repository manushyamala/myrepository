...
public class AppUserLoginFailedReasonDTO implements Serializable {

	private static final long serialVersionUID = 1979209142010867769L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AppUserLoginFailedReasonDTO other = (AppUserLoginFailedReasonDTO) obj;
	...
	public String toString() {
		return "AppUserLoginFailedReasonDTO [id=" + id + ", descEnglish="
