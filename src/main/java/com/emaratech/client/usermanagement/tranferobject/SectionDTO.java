...
public class SectionDTO implements Serializable{
	...
	private static final long serialVersionUID = -7848826326757977876L;
	...
	public String toString() {
		return "SectionDTO [id=" + id + ", descEnglish=" + descEnglish
				+ ", descArabic=" + descArabic + ", readOnly=" + readOnly
				+ ", archived=" + archived + ", departmentId=" + departmentId
				+ "]";
	}
