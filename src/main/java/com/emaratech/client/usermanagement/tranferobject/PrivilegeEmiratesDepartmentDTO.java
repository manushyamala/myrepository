...
public class PrivilegeEmiratesDepartmentDTO implements Serializable{
	
	private static final long serialVersionUID = 5373438936786880045L;
	
	private long id;
    private PrivilegeDTO privilege;
    private EmiratesDepartmentDTO emiratesDepartment;
    
    public PrivilegeEmiratesDepartmentDTO(){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PrivilegeEmiratesDepartmentDTO other = (PrivilegeEmiratesDepartmentDTO) obj;
	...
	public String toString() {
		return "PrivilegeEmiratesDepartmentDTO [id=" + id + ", privilege="
